...
void TM_LEDS_Init(void) {
    ...
    //сопоставляем выводы с альтернативными функциями
...
*/
    TIM_BaseStruct.TIM_Prescaler = 32;
    /* Count up */
...
*/
    TIM_BaseStruct.TIM_Period = 50908; /* 10kHz PWM */
...
*/
    TIM_OCStruct.TIM_Pulse = 6800; /* 25% duty cycle */ //6800-8500
...
//6800-8500 для вращения сервопривода
    	i=0;
    	while(i<1700){
    		i+=10;
    		TIM4->CCR1 += 10;
